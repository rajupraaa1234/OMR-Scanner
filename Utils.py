...
def getAttemtedQuestionList(biggestCont,imgBiggestContours,img,ans):
    if biggestCont.size != 0:
        ...
        imgThersh = cv2.threshold(imgWrapGray,180,225,THRESH_BINARY_INV)[1]
        ...
        for x in range(0,question):
            ...
            if isAttemtedOrValid(arr) == TRUE:
                ...
                if NotAttemptedCase(arr) == TRUE:
                    myIndex.append(choice+2)
                else:
                    myIndex.append(choice+1) 
